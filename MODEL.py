...
msg: You can choose the following model to train your image, and just switch in config.py:
    VGG16,VGG19,InceptionV3,Xception,MobileNet,AlexNet,LeNet,ZF_Net,ResNet18,ResNet34,ResNet50,ResNet101,ResNet152,DenseNet,EfficientNet,NASNet
"""
...
#SENET
class SEResNetXt(object):
    def __init__(self, config, depth=64, reduction_ratio=4, num_split=8, num_block=3):
        ...
        if K.image_data_format() == 'channels_first':
            ...
            self.channel_axis = 3
        self.model = self.build_model(Input(shape=(config.normal_size,config.normal_size,config.channles)), config.classNumber)
